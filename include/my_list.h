...
//FIXME хранить наибольший индекс USED и при реаллокации вниз освобождать все те индексы, которые правее used
...
void WriteDumpHeader(FILE* htm_file, time_tыыыы now);
